...
# dDo concorrrente(jorge teixeira), apoiado pelo prefeito Hobus, esperava-se o oposto.
...
# o modelo do bairro mostra r2 muito maior, isso indica que o resultado possa estar muito mais associado ao local do bairro, do que a essa métrica 0 e 1. Uma métrica que avaliasse o impacto mais detalhada, talvez pudesse captar alguma tendência. 
